...
(function(){
    ...
    $( "button.open-info-product" ).click(function(event) {
      ...
      $.get( href, function(data) {
        ...
        $( infoProduct ).find( "#productBrand" ).text(data.brand);
        $( infoProduct ).find( "#productProcessor" ).text(data.processor);
        $( infoProduct ).find( "#productRam" ).text(data.ram);
        $( infoProduct ).find( "#productStorage" ).text(data.storage);
